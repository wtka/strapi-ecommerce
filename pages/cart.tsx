    ...
    <div className="w-full md:py-20">
      <Wrapper>
          ...
          <div className="flex-[1]">
            ...
            <div className="p-5 my-5 bg-black/[0.05] rounded-xl">
              ...
              <div className="text-sm md:text-base py-5 border-t mt-5">
                The subtotal reflects the toal price of your order, including
                duties and taxes, before any applicable discount. It dose not
        ...
        {/* <div className="flex-[2] flex flex-col items-center pb-[50px] md:mt-14">
          ...
          <span>
            Looks like you have not added anything in yout cart.
            <br />
